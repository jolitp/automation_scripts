...
print("apth current dir: " + path_to_current_directory)
...
for video in all_videos_in_videos_folder:
    ...
    command = f'ffmpeg -i \"{path_to_video_in_videos_folder}\" -r 30 -c:v mpeg2video -q:v 5 -crf 17 -c:a mp2 -b:a 128k -f vob \"{output_video}\"'
