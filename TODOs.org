...
** TODO pad_zeroes_of_files_and_fodlers
...
*** logic
**** TODO if there is no csv file move folder to 0000_no_data/
**** DONE read csv file from hidden folders into list of dicts
**** TODO get the last element of the list
**** TODO get the accumulated duration of the video
**** TODO if duration > 12 hours or 43200 seconds
12 hours = 43200 seconds
***** TODO move folder to 0000_long/
**** TODO else:
***** TODO move folder to 0000_short/
...
***** DONE input have one file should return one section
input: ["single_file"]

expected_output: { "single_file" : ["single_file"] }

***** DONE input have two files should return two sections
input: ["file_1", "file_2"]
...
***** input have three files should return two sections
...
***** input have sections without numbers
input: [
    "section_a_video_1"
    "section_a_video_2"
    "section_b_video_1"
...
>>>>>>> 9a9b4445bc87d9408342dad0aa734c59e022a2e9
* things to try
