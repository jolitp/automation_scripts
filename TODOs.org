...
**** TODO put the name of the folder just before the name of the current video
**** TODO print ffmpeg output to file when done
**** TODO check if dependencies are available
**** TODO have an overall progressbar for all videos in folder
