...
**** TODO create 3 lists: videos, subs, files
**** TODO for each file:
...
**** TODO for each video in the videos list:
...
**** TODO do the same as above to subs
**** TODO do the same as above to files
**** TODO for each of the lists move/rename the files from src > dst
